        ...
        <div className="brand">
          <div className="brand-icon">
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
              <path d="M12 2L3 7v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V7l-9-5z" fill="url(#login-logo-grad)" fillOpacity="0.25" stroke="url(#login-logo-grad)" strokeWidth="1.8"/>
              ...
              <defs>
                <linearGradient id="login-logo-grad" x1="3" y1="2" x2="21" y2="25" gradientUnits="userSpaceOnUse">
